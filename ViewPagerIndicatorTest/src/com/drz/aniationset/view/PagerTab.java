...
public class PagerTab extends ViewGroup {
	...
	private void init() {
		// 把一个值从dip转换成px
		mIndicatorHeight = UIUtils.dip2px(getContext(), mIndicatorHeight);
		mDividerPadding = UIUtils.dip2px(getContext(), mDividerPadding);
		mTabPadding = UIUtils.dip2px(getContext(), mTabPadding);
		mDividerWidth = UIUtils.dip2px(getContext(), mDividerWidth);
		mTabTextSize = UIUtils.dip2px(getContext(), mTabTextSize);
		// 创建一个scroller
